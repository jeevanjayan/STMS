<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tournamentowner.aspx.cs" Inherits="WebApplicationfinal.tournamentowner" %>
    ...
    <asp:Panel ID="Panel1" runat="server" ForeColor="Red" Height="449px" 
        ...
        <asp:Panel ID="Panel3" runat="server" 
            ...
            <asp:Label ID="Label8" runat="server" ForeColor="Black" 
                ...
                Text="TOURNAMENT OWNER" Width="60px"></asp:Label>
