...
<!-- Mirrored from kodeforest.com/html/kickoff/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 26 Oct 2018 15:43:30 GMT -->
<head>
    <meta charset="utf-8">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <ul class="kode-userinfo">
                   ...
                   <li><a href="#" data-toggle="modal" data-target="#myModalTwo"><i class="fa fa-user-plus"></i> Register</a>
		...
		<div class="header-8">
			<div class="container">
				...
				<div class="kode-navigation pull-left">
					<ul>
						 <li><a href="html/index-2.html">Home</a>
						  <%--<ul class="children">
                              <li><a href="html/blog-large.html">Boxed Layout</a></li>
                            </ul>--%>
						 </li>
						 <li><a href="html/team-info.html">About Us</a></li>
                          <!--<li><a href="#">Blog</a>
                            <ul class="children">
                              <li><a href="html/blog-large.html">Blog Large</a></li>
                              <li><a href="html/bloggrid-v2.html">Blog Grid</a></li>
                              <li><a href="html/blog-detail.html">Blog Detail</a>
                                <ul class="children">
                                  <li><a href="html/blog-detail-soundcloud.html">Single SoundCloud</a></li>
                                  <li><a href="html/blog-detail-video.html">Single Video</a></li>
                                </ul>
                              </li>
                            </ul>
                          </li>-->
                          <li><a href="https://kodeforest.com/themes/kickoff-sports-wordpress-theme/">Fixture</a>
                            <ul class="children">
                              <li><a href="html/fixer_list.html">All Matches</a></li>
                              <li><a href="html/fixer_list_view.html">List View</a></li>
                              <li><a href="html/fixture_full_view.html">Full View</a></li>
							  <li><a href="html/fixture-detail.html">Fixture detail</a></li>
                            </ul>
                          </li>
                          <li><a href="gallery-full-width.html">Our Gallery</a>
							<ul class="children">
							  <li><a href="html/gallery-two.html">Gallery 2 Column</a></li>
							  <li><a href="html/gallery-three.html">Gallery 3 Column</a></li>
							  <li><a href="html/gallery-four.html">Gallery 4 Column</a></li>
							   <li><a href="html/gallery-full-width.html">Gallery Full Width</a></li>
							</ul>
						  </li>
				...
				<!--LOGO START-->	
				<div class="logo">
					<a href="html/index-2.html" class="logo"><img src="images/stms.jpg" alt=""></a>
				</div>
				<!--LOGO END-->	
				<!--NAVIGATION START-->
				<div class="kode-navigation">
					<ul>
						...
						<li>
							...
							<ul class="children">
							  <li><a href="html/player-list.html">Players</a></li>
							  <li><a href="html/player-detail.html">Player detail</a></li>
							  <li><a href="html/team-detail.html">Team Detail</a></li>
							</ul>
						  </li>
                           <li><a href="html/faq.html">news</a></li>

						 <li><a href="html/faq.html">Faq</a></li>

                        <!--  <li><a href="#">ShortCode</a>
                            <ul class="children">
                              <li><a href="html/accordian.html">Accordion</a></li>
                              <li><a href="html/button.html">Button</a></li>
                              <li><a href="html/frame.html">Image Frame</a></li>
                              <li><a href="html/list.html">List</a></li>
                              <li><a href="map.html">Map</a></li>
                              <li><a href="html/message.html">Message</a></li>
                              <li><a href="html/sepratore.html">Separator</a></li>
                          ...
                          <li class="last"><a href="#">contact</a>
                            <ul class="children">
                              <li><a href="html/contact-us.html">Contact V1</a></li>
                              <li><a href="html/contact-ustwo.html">Contact V2</a></li>
                            </ul>
                          </li>
					</ul>
				</div>
                      ...
                      <div class="collapse navbar-collapse" id="navbar-collapse">
                        <ul class="nav navbar-nav">
						 ...
						 <li><a href="html/team-info.html">About Us</a></li>
						  ...
						  <li><a href="html/gallery-two.html">Our Gallery</a>
							<ul class="children">
							  <li><a href="html/gallery-two.html">Gallery 2 Column</a></li>
							  <li><a href="html/gallery-three.html">Gallery 3 Column</a></li>
							  <li><a href="html/gallery-four.html">Gallery 4 Column</a></li>
							  <li><a href="html/-full-width.html">Gallery Full Width</a></li>
							</ul>
						  </li>
						 <li>
							<a href="#">Team & Player</a>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <article>
                      ...
                      <div class="kode-result-thumb">
                        <a href="#"><img src="extra-images/result-logo1.png" alt=""></a>
                      </div>
                  ...
                  <div class="col-md-6">
                    <article class="kode-even">
                      ...
                      <div class="kode-result-thumb">
                        <a href="#"><img src="extra-images/result-logo2.png" alt=""></a>
                      </div>
                      <div class="kode-result-info">
              ...
              <div class="col-md-12">
                <div class="kode-section-title"> <h2>Top Player</h2> </div>
                  ...
                  <div class="owl-carousel-team owl-theme kode-team-list next-prev-style">
                    <div class="item">
                      <figure><a href="#" class="kode-team-thumb"><img src="extra-images/player-1.jpg" alt=""></a>
                        <figcaption>
                    ...
                    <div class="item">
                      <figure><a href="#" class="kode-team-thumb"><img src="extra-images/player-2.jpg" alt=""></a>
                        <figcaption>
                          <ul class="kode-team-network">
                            <li><a href="#" class="fa fa-facebook"></a></li>
                            <li><a href="#" class="fa fa-twitter"></a></li>
                    ...
                    <div class="item">
                      <figure><a href="#" class="kode-team-thumb"><img src="extra-images/player-3.jpg" alt=""></a>
                        <figcaption>
                          <ul class="kode-team-network">
                            <li><a href="#" class="fa fa-facebook"></a></li>
                            <li><a href="#" class="fa fa-twitter"></a></li>
                    ...
                    <div class="item">
                      <figure><a href="#" class="kode-team-thumb"><img src="extra-images/player-4.jpg" alt=""></a>
                        <figcaption>
                          <ul class="kode-team-network">
                            <li><a href="#" class="fa fa-facebook"></a></li>
                            <li><a href="#" class="fa fa-twitter"></a></li>
                  ...
                  <div class="kode-blog-list kode-large-blog">
                    <ul class="row">
                      ...
                      <li class="col-md-4">
                        ...
                        <figure><a href="#"><img src="extra-images/bloggird-1.jpg" alt=""></a></figure>
                      ...
                      <li class="col-md-4">
                        ...
                        <figure><a href="#"><img src="extra-images/bloggird-2.jpg" alt=""></a></figure>
                        <div class="kode-blog-info">
                          <p>Lorem ipsum dolor sit amet, cons ecte tuer adipiscing elit, sed diam non ummy nibh euismod tinc idunt ut laoreet dolore magna ali quam erat volutpat. Ut veniam, quis..</p>
                          <a href="#" class="kode-blog-btn">Read More</a>
                          <div class="clearfix"></div>
                      ...
                      <li class="col-md-4">
                        ...
                        <figure><a href="#"><img src="extra-images/bloggird-3.jpg" alt=""></a></figure>
                        <div class="kode-blog-info">
                          <p>Lorem ipsum dolor sit amet, cons ecte tuer adipiscing elit, sed diam non ummy nibh euismod tinc idunt ut laoreet dolore magna ali quam erat volutpat. Ut veniam, quis..</p>
                          <a href="#" class="kode-blog-btn">Read More</a>
                          <div class="clearfix"></div>
			...
			<div class="container">
				<div class="row">
                  ...
                  <div class="kode-gallery kode-gallery-pretty">
                    <ul class="row">
                      <li class="col-md-4">
                        <figure><a href="#"><img src="extra-images/gallery-list-1.jpg" alt=""></a>
                          <figcaption><a data-gal="prettyphoto" href="extra-images/gallery-list-1.jpg" class="kode-gallery-hover thbg-color"><i class="fa fa-plus"></i></a></figcaption>
                        </figure>

                      </li>
                      <li class="col-md-4">
                        <figure><a href="#"><img src="extra-images/gallery-list-2.jpg" alt=""></a>
                          <figcaption><a data-gal="prettyphoto" href="extra-images/gallery-list-1.jpg" class="kode-gallery-hover thbg-color"><i class="fa fa-plus"></i></a></figcaption>
                        </figure>

                      </li>
                      <li class="col-md-4">
                        <figure><a href="#"><img src="extra-images/gallery-list-3.jpg" alt=""></a>
                          <figcaption><a data-gal="prettyphoto" href="extra-images/gallery-list-1.jpg" class="kode-gallery-hover thbg-color"><i class="fa fa-plus"></i></a></figcaption>
                        </figure>

                      </li>
                      <li class="col-md-4">
                        <figure><a href="#"><img src="extra-images/gallery-list-4.jpg" alt=""></a>
                          <figcaption><a data-gal="prettyphoto" href="extra-images/gallery-list-1.jpg" class="kode-gallery-hover thbg-color"><i class="fa fa-plus"></i></a></figcaption>
                        </figure>

                      </li>
                      <li class="col-md-4">
                        <figure><a href="#"><img src="extra-images/gallery-list-5.jpg" alt=""></a>
                          <figcaption><a data-gal="prettyphoto" href="extra-images/gallery-list-1.jpg" class="kode-gallery-hover thbg-color"><i class="fa fa-plus"></i></a></figcaption>
                        </figure>

                      </li>
                      <li class="col-md-4">
                        <figure><a data-ral="" href="#"><img src="extra-images/gallery-list-6.jpg" alt=""></a>
                          <figcaption><a data-gal="prettyphoto" href="extra-images/gallery-list-1.jpg" class="kode-gallery-hover thbg-color"><i class="fa fa-plus"></i></a></figcaption>
                        </figure>
                  ...
                  <div class="owl-carousel owl-theme">
                    <div class="item">
                      <div class="kode-pro-inner">
                        <figure><a href="#"><img src="extra-images/shop-product1.jpg" alt=""></a>
                          <figcaption>
                    ...
                    <div class="item">
                      <div class="kode-pro-inner">
                        <figure><a href="#"><img src="extra-images/shop-product2.jpg" alt=""></a>
                          <figcaption>
                            <h4><a href="#">Product Name</a></h4>
                            <p class="kode-pro-cat"><a href="#">Categories</a></p>
                          </figcaption>
                    ...
                    <div class="item">
                      <div class="kode-pro-inner">
                        <figure><a href="#"><img src="extra-images/shop-product3.jpg" alt=""></a>
                          <figcaption>
                            <h4><a href="#">Product Name</a></h4>
                            <p class="kode-pro-cat"><a href="#">Categories</a></p>
                          </figcaption>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                  <div class="kode-partner">
                    <ul class="row">
                      <li class="col-md-3"><a href="#"><img src="extra-images/partner-logo2.jpg" alt=""></a></li>
				...
				<div class="row">
					...
					<div class="col-md-4">
						<div class="widget widget-flickr kode-gallery-pretty">
							<h3>Flickr</h3>
							<ul>
								<li><a data-gal="prettyphoto" href="extra-images/widgetgallery-2.jpg"><img alt="" src="extra-images/widgetgallery-1.jpg"></a></li>
								<li><a data-gal="prettyphoto" href="extra-images/widgetgallery-2.jpg"><img alt="" src="extra-images/widgetgallery-2.jpg"></a></li>
								<li><a data-gal="prettyphoto" href="extra-images/widgetgallery-2.jpg"><img alt="" src="extra-images/widgetgallery-3.jpg"></a></li>
								<li><a data-gal="prettyphoto" href="extra-images/widgetgallery-2.jpg"><img alt="" src="extra-images/widgetgallery-1.jpg"></a></li>
								<li><a data-gal="prettyphoto" href="extra-images/widgetgallery-2.jpg"><img alt="" src="extra-images/widgetgallery-2.jpg"></a></li>
								<li><a data-gal="prettyphoto" href="extra-images/widgetgallery-2.jpg"><img alt="" src="extra-images/widgetgallery-3.jpg"></a></li>
								<li><a data-gal="prettyphoto" href="extra-images/widgetgallery-2.jpg"><img alt="" src="extra-images/widgetgallery-1.jpg"></a></li>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form class="kode-loginform" runat="server">
              <p><span>User Name</span> <asp:Textbox   runat="server" ID="username"
                      style="color: #000000"></asp:Textbox></p>
              <p><span>Password</span> <asp:Textbox  runat="server"   ID="password" 
                      style="color: #000000"></asp:Textbox></p>
              <p><label><input type="checkbox"><span>Remember Me</span></label></p>
              <p class="kode-submit"><a href="#">Lost Your Password</a></p>
...
<!-- Mirrored from kodeforest.com/html/kickoff/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 26 Oct 2018 15:45:11 GMT -->
</html> 