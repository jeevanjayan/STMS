<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="trmntreg.aspx.cs" Inherits="WebApplicationfinal.trmntreg" %>
...
<form id="form2" runat="server">
    <asp:Panel ID="Panel1" runat="server" BorderColor="Red" BorderStyle="none" 
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
            ...
            style="z-index: 1; left: 449px; top: 179px; position: absolute"></asp:RequiredFieldValidator>
        <asp:Label ID="Label1" runat="server" 
    
            style="z-index: 1; left: 124px; top: 16px;font-family:  sans-serif; position: absolute; width: 446px; font-weight: 700; font-size: xx-large; height: 41px; text-align: center;" 
            Text="Tournament Registration"></asp:Label>
    </asp:Panel>
    <asp:Label ID="Label2" runat="server" 
        style="z-index: 1; left: 156px; top: 151px; position: absolute; width: 120px" 
        Text="Tournament Name"></asp:Label>
    <asp:Label ID="Label3" runat="server" 
        style="z-index: 1; left: 160px; top: 205px; position: absolute; height: 24px; text-align: left; width: 121px; right: 767px;" 
        Text="Department Name"></asp:Label>
    <asp:Label ID="Label4" runat="server" 
        style="z-index: 1; left: 161px; top: 258px; position: absolute; width: 103px; right: 784px;" 
        Text="Username"></asp:Label>
    <asp:Label ID="Label5" runat="server" 
        style="z-index: 1; left: 163px; top: 306px; position: absolute; width: 124px; height: 26px" 
        Text="Password"></asp:Label>
    <asp:Label ID="Label6" runat="server" 
        style="z-index: 1; left: 161px; top: 355px; position: absolute" 
        Text="Confirm Password"></asp:Label>
    <asp:TextBox ID="TextBox1" runat="server" required placeholder="Enter tournament name" 
        
        
        style="z-index: 1;color:Black; left: 451px; top: 155px; position: absolute; text-align: left ;" 
        ontextchanged="TextBox1_TextChanged"></asp:TextBox>
    <asp:TextBox ID="TextBox3"  runat="server" placeholder="Username" required
        style="z-index: 1;color:Black;  left: 449px; top: 258px; position: absolute; "></asp:TextBox>
    <asp:TextBox ID="TextBox4" runat="server" placeholder="Password" required
        style="z-index: 1; color:Black;  left: 449px; top: 307px; position: absolute; "></asp:TextBox>
    <asp:TextBox ID="TextBox5" runat="server"  placeholder="Password" required
    ...
    <asp:CompareValidator ID="CompareValidator1" runat="server" 
        ...
        style="z-index: 1; left: 598px; top: 354px; position: absolute"></asp:CompareValidator>
    <p>
