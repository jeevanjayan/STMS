<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Teamplayers.aspx.cs" Inherits="WebApplicationfinal.Teamplayers" %>
...
<div class="col-sm-12">
    ...
    font-family: sans-serif;
    letter-spacing: 1px;
    font-weight: bold;" >Player details</div>
    ...
    <td><asp:TextBox ID="ad1" runat="server"></asp:TextBox></td>
    <td><asp:TextBox ID="age1" runat="server"></asp:TextBox></td>
    </tr>
    <tr>
    
    <td><asp:TextBox ID="name2" runat="server"></asp:TextBox></td>
    <td><asp:TextBox ID="ad2" runat="server"></asp:TextBox></td>
    <td><asp:TextBox ID="age2" runat="server"></asp:TextBox></td>
    </tr>
    <tr>
    
    <td><asp:TextBox ID="name3" runat="server"></asp:TextBox></td>
    <td><asp:TextBox ID="ad3" runat="server"></asp:TextBox></td>
    <td><asp:TextBox ID="age3" runat="server"></asp:TextBox></td>
    </tr>
    <tr>
    
    <td><asp:TextBox ID="name4" runat="server"></asp:TextBox></td>
    <td><asp:TextBox ID="ad4" runat="server"></asp:TextBox></td>
    <td><asp:TextBox ID="age4" runat="server"></asp:TextBox></td>
    </tr>
    <tr>
    
    <td><asp:TextBox ID="name5" runat="server"></asp:TextBox></td>
    <td><asp:TextBox ID="ad5" runat="server"></asp:TextBox></td>
    <td><asp:TextBox ID="age5" runat="server"></asp:TextBox></td>
    </tr>
    <tr>
    
    <td><asp:TextBox ID="name6" runat="server"></asp:TextBox></td>
    <td><asp:TextBox ID="ad6" runat="server"></asp:TextBox></td>
    <td><asp:TextBox ID="age6" runat="server"></asp:TextBox></td>
    </tr>
    <tr>
    
    <td><asp:TextBox ID="name7" runat="server"></asp:TextBox></td>
    <td><asp:TextBox ID="ad7" runat="server"></asp:TextBox></td>
    <td><asp:TextBox ID="age7" runat="server"></asp:TextBox></td>
    </tr>
    <tr>
    
    <td><asp:TextBox ID="name8" runat="server"></asp:TextBox></td>
    <td><asp:TextBox ID="ad8" runat="server"></asp:TextBox></td>
    <td><asp:TextBox ID="age8" runat="server"></asp:TextBox></td>
    </tr>
    <tr>
    
    <td><asp:TextBox ID="name9" runat="server"></asp:TextBox></td>
    <td><asp:TextBox ID="ad9" runat="server"></asp:TextBox></td>
    <td><asp:TextBox ID="age9" runat="server"></asp:TextBox></td>
    </tr>
    <tr>
    
    <td><asp:TextBox ID="name10" runat="server"></asp:TextBox></td>
    <td><asp:TextBox ID="ad10" runat="server"></asp:TextBox></td>
    <td><asp:TextBox ID="age10" runat="server"></asp:TextBox></td>
    </tr>
    <tr>
    
    <td><asp:TextBox ID="name11" runat="server"></asp:TextBox></td>
    <td><asp:TextBox ID="ad11" runat="server"></asp:TextBox></td>
    <td><asp:TextBox ID="age11" runat="server"></asp:TextBox></td>
    </tr>
    </table>
        
        <div class="col-sm-12">
        <asp:Button class="logoutt" Text="Save" style="width:20%" runat="server" onclick="Button1_Click"  />
        </div>
