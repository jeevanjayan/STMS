<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Teamdetails.aspx.cs" Inherits="WebApplicationfinal.Teamdetails" %>
...
<div style="text-align: center;
    ...
    letter-spacing: 1px;
    font-weight: bold;" >Team details</div>
    <div class="row">
    <div class="col-sm-6">
    
    <div class="detailss">Team Id</div>
    <div class="detailss">Team name</div>
    <div class="detailss">Department name</div>
    <div class="detailss">Semester</div>
    <div class="detailss">Phone no</div>
    <div class="detailss">Team captain</div>
    
    <div class="detailss">Email</div>
    
    </div>
    <div style="display:block;" class="col-sm-6">
    <asp:TextBox type="text" runat="server" id="teid" ReadOnly required  class="inputcl" />
    <br />
     <asp:TextBox type="text" runat="server" id="teamName" ReadOnly required  class="inputcl" />
    <br />
    <asp:TextBox type="text" runat="server" id="depnamee" ReadOnly required  class="inputcl" />
    <br />
    <asp:TextBox type="text" runat="server" id="temsem" ReadOnly required  class="inputcl" />
    <br />
        
        
        
        <asp:TextBox type="text" runat="server" id="temPhon" required  class="inputcl" />
    <br />
    <asp:TextBox type="text" runat="server" id="temCapt" required  class="inputcl" />
    <br />
    <asp:TextBox type="text" runat="server" id="temEmail" required  class="inputcl" />
    <br />
