...
namespace WebApplicationfinal
{
    public partial class teamregs : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string sq = "insert into team_details(teid,tename,tedepartment,tesemester,teusername,tepassword) values(@teid,@tename,@tedepartment,@tesemester,@teusername,@tepassword)";
            SqlCommand cmd = new SqlCommand(sql, conn);
            SqlCommand cm = new SqlCommand(sq, conn);
            string dropdtn =  DropDownList11.SelectedItem.Value.ToString();
