...
<form id="form1" runat="server">
    <asp:Panel ID="Panel1" runat="server" BorderStyle="none" 
        ...
        style="z-index: 1; left: 51px; top: 25px; position: absolute; height: 72px; width: 685px; text-align: center">
        <asp:Label ID="Label1" runat="server" 
    
            style="z-index: 1; left: 124px; top: 16px; position: absolute; width: 446px; font-weight: 700; font-size: xx-large; height: 41px; text-align: center;" 
            Text="Team Registration"></asp:Label>
    </asp:Panel>
    ...
    <asp:DropDownList ID="DropDownList3" runat="server" 
        style="z-index: 1; left: 505px; top: 344px; position: absolute; width: 126px; right: 420px">
    ...
    <asp:Label ID="Label2" runat="server" 
        style="z-index: 1; left: 167px; top: 160px; position: absolute; width: 120px; right: 491px;" 
        Text="Tournament Name"></asp:Label>
    <asp:Label ID="Label3" runat="server" 
        style="z-index: 1; left: 167px; top: 220px; position: absolute; height: 24px; text-align: left; width: 120px" 
        Text="Team Name"></asp:Label>
    <asp:Label ID="Label4" runat="server" 
        style="z-index: 1; left: 167px; top: 400px; position: absolute; width: 120px" 
        Text="Username"></asp:Label>
    <asp:Label ID="Label5" runat="server" 
        style="z-index: 1; left: 167px; top: 460px; position: absolute; width: 120px; height: 26px; bottom: 98px;" 
        Text="Password"></asp:Label>
    <asp:Label ID="Label6" runat="server" 
        style="z-index: 1; left: 167px; top: 520px; position: absolute; " 
        Text="Confirm Password"></asp:Label>
    <asp:Label ID="Label7" runat="server" 
        style="z-index: 1; left: 170px; top: 280px; position: absolute; width: 117px" 
        Text="Department Name "></asp:Label>
    <asp:Label ID="Label8" runat="server" 
        style="z-index: 1; left: 167px; top: 340px; position: absolute; width: 85px; right: 520px" 
    ...
    <asp:TextBox ID="TextBox1" runat="server" 
        ...
        style="z-index: 1; left: 507px; top: 222px; position: absolute;color:Black;  text-align: left; width: 128px; right: 416px;"></asp:TextBox>
    ...
    <asp:TextBox ID="TextBox4" runat="server" 
        ...
        style="z-index: 1; left: 500px; top: 452px;color:Black;  position: absolute; width: 128px"></asp:TextBox>
    <asp:TextBox ID="TextBox5" runat="server" 
        
        
        
        style="z-index: 1; left: 500px; top: 511px;color:Black;  position: absolute; width: 128px; "></asp:TextBox>
    ...
    <asp:CompareValidator ID="CompareValidator1" runat="server" 
        ...
        style="z-index: 1; top: 501px; position: absolute; width: 167px; right: -10px; height: 38px; bottom: 205px"></asp:CompareValidator>
    <asp:Button ID="Button1" runat="server" 
        
        style="z-index: 1; left: 481px; top: 594px; position: absolute; width: 84px;" 
