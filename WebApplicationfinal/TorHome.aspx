<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TorHome.aspx.cs" Inherits="WebApplicationfinal.TorHome" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <title>Tornament Home page</title>
                 ...
                 <div class="main">
                    <div  class="carouel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                              ...
                              <div class="item">
                                <img src="Styles/extra-images/slide2.jpg" alt="Chicago">
                              </div>
                          
                              <div class="item">
                                <img src="Styles/extra-images/slide3.jpg" alt="New York">
                              </div>
                            </div>
...
<div class="col-sm-12">
    ...
    letter-spacing: 1px;
    font-weight: bold;" >Tournament Owner</div>
    <div style="padding: 2px;
    display: flex;
    border: 1.6px solid white;">
    <div class="listt">
    <asp:LinkButton id="btnLogout" style="color:White;" Text="Tournament details"  
            runat="server" onclick="btnLogout_Click"/>
            </div>
    <div class="listt">
    <asp:LinkButton style="color:White;" Text="Team approval" 
            runat="server" id="Unnamed1" onclick="Unnamed1_Click">
            </asp:LinkButton>
            </div>
    <div class="listt">
    <asp:LinkButton  style="color:White;" Text="View teams" 
